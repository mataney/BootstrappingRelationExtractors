...
class TACREDDataset(Dataset):
    def __init__(self, tokenizer, output_dir, file_path='train', block_size=512):
        ...
        cached_features_file = os.path.join(directory, f'cached_{output_dir}_lm_{block_size}_{filename}')
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    perplexity = torch.exp(torch.tensor(eval_loss)) # pylint: disable=not-callable

...
all_triggers_children_patterns = ["{e1:e=PERSON John} 's [t:w=baby|child|children|daughter|daughters|son|sons|step-daughter|step-son|step-child|step-children|stepchildren|stepdaughter|stepson daughter] , {e2:e=PERSON Tim} .",
...
all_triggers_country_of_headquarters_patterns = ["John Doe, a professor at the {e1:e=ORGANIZATION Technion} [in:t=IN in] {e2:e=LOCATION Israel} likes running.",
                                                 "{e1:e=ORGANIZATION Technion}, a leading {t:t=/NN/ company} {in:t=IN in} {e2:e=LOCATION Israel}.",
                                                 "{e2:e=LOCATION Israel} [pos:t=POS '] largest university is {e1:e=ORGANIZATION BIU}."]
all_triggers_religion_patterns = ["{e1:e=PERSON John} is a [e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Jewish]",
                                  "[e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Jewish] {e1:e=PERSON John} is walking down the street.",
                                  "{e1:e=PERSON John} is a [e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Methodist] Person."]
...
all_triggers_origin_patterns = ["{e2:e=MISC Scottish} {e1:e=PERSON Mary} is high.",
                                "{e1:e=PERSON Mary} is a {e2:e=MISC Scottish} professor.",
                                "{e1:e=PERSON Mary}, the {e2:e=LOCATION US} professor."]
...
docred_founded_by_patterns = ["[e2:e=MISC Scottish] {e1:e=ORGANIZATION Microsoft} is high.",
                              "{e1:e=ORGANIZATION|MISC Microsoft} is a [e2:e=MISC Scottish] professor.",
                              "{e1:e=ORGANIZATION|MISC Microsoft}, the {e2:e=LOCATION US} professor."]
docred_religion_patterns = ["{e1:e=PERSON|ORGANIZATION John} is [e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Jewish]",
                            "[e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Jewish] {e1:e=PERSON|LOCATION|ORGANIZATION John} is walking down the street.",
                            "{e1:e=PERSON|LOCATION|ORGANIZATION John} is a [e2:w=Methodist|Episcopal|separatist|Jew|Christian|Sunni|evangelical|atheism|Islamic|secular|fundamentalist|Christianist|Jewish|Anglican|Catholic|orthodox|Scientology|Islamist|Islam|Muslim|Shia Methodist] person.",]
docred_origin_patterns = ["{e2:e=MISC Scottish} company, {e1:e=ORGANIZATION Mary} is high.",
                          "{e1:e=ORGANIZATION|MISC Mary} is a {e2:e=MISC Scottish} professor.",
                          "{e1:e=ORGANIZATION|MISC Mary} is a {t:t=/NN/ song} [$ by] {e2:e=MISC Scottish} musican."]
...
SINGLE_TRIGGER_PATTERNS = {
    ...
    'docred': {
        ...
        "per:religion": docred_religion_patterns,
        "per:spouse": spouse_patterns,
...
ALL_TRIGGERS_PATTERNS = {} #Needs to be constructed so won't run same things twice.
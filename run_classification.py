...
from classification.re_processors import compute_metrics
from classification.re_processors import convert_examples_to_features
from classification.re_processors import output_modes
from classification.re_processors import processors
from classification.re_processors import RELATION_MAPPING, TITLE_NAMES
...
def load_and_cache_examples(args, task, tokenizer, set_type="train"):
    ...
    processor = processors[task](args.relation_name, args.num_positive_examples, args.ratio_negative_examples, args.type_independent_neg_sample)
    ...
    cached_features_file = os.path.join(
        ...
        "cached_{}_{}_{}_{}_{}_{}_{}".format(
            ...
            str(args.ratio_negative_examples),
        ),
    )
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The name of the task to train selected in the processors_factory function",
    )
    parser.add_argument(
        "--relation_name",
        default=None,
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="The ratio of negative examples allowed for classification comparing to positive examples",
    )
    parser.add_argument(
        "--output_dir",
        default=None,
    ...
    parser.add_argument("--type_independent_neg_sample",
                        action="store_true",
    ...
    if (
        ...
        and (args.do_train or args.do_distant_train or args.do_search_train or args.do_search_from_generation_train or args.do_generation_train)
    ...
    processor = processors[args.task_name](args.relation_name, args.num_positive_examples, args.ratio_negative_examples, args.type_independent_neg_sample)
